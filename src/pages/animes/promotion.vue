        ...
        <view class="main-wrapper pb30">
            ...
            <view class="default-info-list">
                <view class="item">
                    ...
                    <view class="value">漫剧</view>
                </view>
                <view class="item">
                    <view class="name">剧名：</view>
                    <view class="value">{{ anime_name }}</view>
                </view>
            </view>
            <view class="bar-title">
                <view class="bar-title-bg">
...
onLoad((e: any) => {
    anime_id.value = e.anime_id;
    anime_name.value = e.anime_name;
});
</script>
