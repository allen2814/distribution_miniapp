        ...
        <view class="main-wrapper pb30">
            ...
            <view class="default-info-list">
                <view class="item">
                    ...
                    <view class="value">书单</view>
                </view>
                <view class="item">
                    <view class="name">书单名：</view>
                    <view class="value l1">{{ book_list_name }}</view>
                </view>
            </view>
            <view class="bar-title">
                <view class="bar-title-bg">
...
const book_list_id = ref<number>();
const book_list_name = ref<string>("");
...
onLoad((e: any) => {
    book_list_id.value = e.book_list_id;
    book_list_name.value = e.book_list_name;
});
</script>
