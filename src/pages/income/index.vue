    ...
    <z-paging ref="paging" class="page" v-model="list" @query="getList">
        ...
        <view class="income-list">
            ...
            <template v-else>
                ...
                <activity-redpacket-item :list="list" v-else-if="tabIndex === 2" />
...
import ActivityRedpacketItem from '@/components/activity-redpacket-item.vue';
...
const getList = async (pageNo?: number, pageSize?: number) => {
    ...
    if (tabIndex.value === 0) {
        ...
        const { data } = await ApiActivityList(params);
